...
export abstract class BaseAdapter implements JobSourceAdapter {
  abstract readonly source: string;

  protected readonly logger = new Logger(BaseAdapter.name);

  constructor(protected readonly rateLimiter: RateLimiterService) {}
  ...
  protected abstract syncCompany(company: Company): Promise<void>;
}
